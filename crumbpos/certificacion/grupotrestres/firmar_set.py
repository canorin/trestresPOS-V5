"""
Firma todos los XMLs del set de pruebas — GRUPO TRESTRES SPA.

Proceso:
1. Cargar certificado PFX
2. Para cada sobre (EnvioDTE):
...
COPIA EXACTA del motor de nuevapostulacion/firmar_set.py
Solo cambian: rutas de certificado y output.
"""
import sys
import re
import base64
...
def firmar_sobre(xml_path: Path, firma: Firma) -> Path:
    """Firma un sobre EnvioDTE completo."""
